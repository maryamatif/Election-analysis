...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (CountyVotes > winning_county_totalvotes):
            winning_county_totalvotes = CountyVotes
    ...
    winning_county_summary = (
        ...
        f"Winning County total votes: {winning_county_totalvotes:,}\n"
        f"-------------------------\n")
